...
of writing) on \href{https://arxiv.org}{arXiv}.
% XXX XXX XXX They've switched to 2020?
...
\pkg{xparse} parse arguments differently, so things like
...
% XXX Split into two separate examples? Better example (i.e., to better show off
% how it actually will look with proper pseudocode)?
...
\begin{docKey}{compact}{\,=\,\meta{boolean}}{default \code{true}, initially
    ...
    if we're in inner horizontal mode at the beginning of the environment.
