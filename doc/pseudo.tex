...
% XXX This is also relevant for the tabularx example.
% XXX hd-preamble -- not really relevant here, but relevant for tabularx
\begin{texexp}
\begin{pseudo}[preamble = {
        >{\pseudohpad} \pseudolabelalign
        >{\pseudosetup} p{11.7cm} <{\pseudohpad}
    },
    setup-append = \raggedright\pseudoslash,
    line-height = 1.5]
...
the setup (with \refk{setup-append}, with \cs{pseudoslash} to restore
