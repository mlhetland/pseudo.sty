...
\NewDocumentCommand \shortcutted { m m } {%
    ...
    get the shorter version, simply use \code{\cs{let}\cs{#1}\cs{#2}}.%
}
...
\tcbset{
    ...
    sidebar/.style = {
        infobox,
        float,
        borderline horizontal = {2.5pt}{0pt}{black!25},
        toprule = 2.5pt,
        bottomrule = 2.5pt,
        toptitle = 8pt,
        top = 5pt,
...
\NewDocumentCommand \Abstract { } {
    ...
    \null
    \vfill
    \begin{tcolorbox}[sidebar, nofloat]
    % \noindent
    \tl_use:N \g_tmpa_tl
    \end{tcolorbox}
    \vfill
...
if you use packages that rely on \cs{:}, such a redefinition might cause trouble.
\end{sidebar}
...
\begin{note}
    ...
    so if you insert anything between te
\end{note}
...
\refc{pseudodefinestyle}), adapted from the default, as in the following.
\begin{note}
The default is
