...
\begin{internalpseudobox}[pseudo/boxed]{\refk{pseudo/boxed}}{boxed}
\begin{pseudo}[kw]
    $i = 1$ \\
    while $i < n$\\+
        if \nf $i\== 1$ or $A[i-1] \leq A[i]$ \\+
...
\begin{internalpseudobox}[pseudo/boxruled]{\refk{pseudo/boxruled}}{boxruled}
\begin{pseudo}[kw]
    $i = 1$ \\
    while $i < n$\\+
        if \nf $i\== 1$ or $A[i-1] \leq A[i]$ \\+
...
\begin{internalpseudobox}[pseudo/tworuled]{\refk{pseudo/tworuled}}{tworuled}
\begin{pseudo}[kw]
    $i = 1$ \\
    while $i < n$\\+
        if \nf $i\== 1$ or $A[i-1] \leq A[i]$ \\+
...
\begin{internalpseudobox}[pseudo/filled]{\refk{pseudo/filled}}{filled}
\begin{pseudo}[kw]%*
    $i = 1$ \\
    while $i < n$\\+
        if \nf $i\== 1$ or $A[i-1] \leq A[i]$ \\+
...
\refk{pseudo/filled}), starting with that style may be easier.
