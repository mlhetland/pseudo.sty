...
\code{1\refc{..}n} to produce $1\rng n$, you can redefine \refc{dts}---or,
rather, its fully prefixed version, which is what \refc{..} uses
internally---with \code{\cs{let}\cs{pseudodts}\refc{rng}}.
...
\begin{docCommand}{..}{}
    ...
    like to use the \refc{..} shortcut, but prefer to use \refc{rng} as your
