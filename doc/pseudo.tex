...
\cs{caption}), you'll need to either call \refc{RestorePseudoEqs} to
...
\begin{docCommand}{==}{}
    \RestorePseudoEqs % Having some trouble bc/o floats, or something?
    ...
    the \refc{==} shortcut) by using \refc{RestorePseudoEqs}. In some cases, you
...
\begin{docCommand}{RestorePseudoEqs}{}
...
by adding \code{>\braces{\refc{RestorePseudoEqs}}} before each
...
\cs_gset_eq:NN \@@_eq: \= % Stored for \RestorePseudoEqs
\end{source}
...
overwritten:
\begin{source}
\NewDocumentCommand \RestorePseudoEqs { } {
    \cs_gset_eq:NN \= \@@_eq:
}
\end{source}
...
\NewDocumentCommand \pseudoeq { } {
    \@@_use_instead:nn \pseudoeq \RestorePseudoEqs
    \RestorePseudoEqs
}
\end{source}
